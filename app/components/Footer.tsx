              ...
              {status === 'success' ? (
                ...
                >
                  {/* Heading — eyebrow + serif headline matches the
                       "Contact us today / We organize the stay of your dreams"
                  ...
                  >
                    ...
                    <span>{status === 'submitting' ? 'Sending…' : 'Speak to an Expert'}</span>
                    {status !== 'submitting' && (
                      <span
                        aria-hidden="true"
              ...
              <div className="flex items-center gap-3">
                {[
                  ...
                  <a
                    ...
                    href="#"
                    aria-label={s.label}
                    className="w-9 h-9 flex items-center justify-center rounded-full bg-white/8 border border-white/10 text-white/70 hover:text-white hover:bg-[#E07B39] hover:border-[#E07B39] transition-colors"
                  >
            ...
            <div className="lg:col-span-3">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { label: 'Special Interest', href: '/our-services/special-interest' },
