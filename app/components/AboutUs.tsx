    ...
    >
      ...
      <div className="w-full bg-white pt-8 md:pt-10 lg:pt-12 pb-8 md:pb-10 lg:pb-12">
        <Reveal className="w-[90%] max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          >
            We design and operate bespoke India programmes for tour operators, travel advisors, corporate buyers and travellers — built on authentic access, on-ground precision, and seamless execution. Every experience reflects a deep understanding of place, culture, and heritage, crafted with care and delivered with quiet excellence.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            name: 'Liberty India',
            description:
              'Liberty India is a premier Destination Management Company specialising in bespoke India programmes for tour operators, travel advisors, corporate buyers and travellers.',
