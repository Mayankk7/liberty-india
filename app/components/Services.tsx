    ...
    >
      ...
      <div className="max-w-[80%] mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row gap-1.5 mb-1.5">
          ...
          <div className="md:w-[28%] group relative h-[500px] md:h-[700px] rounded-lg overflow-hidden cursor-pointer transition-all duration-500 ease-out hover:shadow-2xl hover:-translate-y-1" onClick={() => window.location.href = '/cruise-handling'} tabIndex={0} role="button" onKeyPress={e => { if (e.key === 'Enter' || e.key === ' ') window.location.href = '/cruise-handling'; }} aria-label={services[0].title}>
            <Image
          ...
          <div className="md:w-[72%] flex flex-col gap-1.5">
            ...
            <div className="flex gap-1.5">
              ...
              {/* Premium Leisure */}
              <div className="w-1/2 group relative h-[400px] md:h-[650px] rounded-lg overflow-hidden cursor-pointer transition-all duration-500 ease-out hover:shadow-2xl hover:-translate-y-1" onClick={() => window.location.href = '/premium-leisure'} tabIndex={0} role="button" onKeyPress={e => { if (e.key === 'Enter' || e.key === ' ') window.location.href = '/premium-leisure'; }} aria-label={services[2].title}>
                <Image
        ...
        <div className="flex flex-col md:flex-row gap-1.5 mb-1.5 md:-mt-[300px]">
          ...
          <div className="md:w-[28%] group relative h-[500px] md:h-[700px] rounded-lg overflow-hidden cursor-pointer transition-all duration-500 ease-out hover:shadow-2xl hover:-translate-y-1" onClick={() => window.location.href = '/education-tours'} tabIndex={0} role="button" onKeyPress={e => { if (e.key === 'Enter' || e.key === ' ') window.location.href = '/education-tours'; }} aria-label={services[4].title}>
            <Image
        ...
        <div className="flex flex-col md:flex-row gap-1.5">
          ...
          <div className="md:w-1/2 group relative h-[250px] md:h-[320px] rounded-lg overflow-hidden cursor-pointer transition-all duration-500 ease-out hover:shadow-2xl hover:-translate-y-1" onClick={() => window.location.href = '/special-interest'} tabIndex={0} role="button" onKeyPress={e => { if (e.key === 'Enter' || e.key === ' ') window.location.href = '/special-interest'; }} aria-label={services[5].title}>
            <Image
