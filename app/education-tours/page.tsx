    ...
    <main className="min-h-screen bg-white w-full overflow-x-hidden">
        ...
        <div className="relative w-screen max-w-none m-0 p-0" style={{height:'700px'}}>
          <div className="grid grid-cols-1 md:grid-cols-3 w-screen h-full m-0 p-0">
            <div className="relative h-full w-full">
              <Image src="https://ik.imagekit.io/libertyindia/services/education-tours/picture-1.png" alt="Education Tour 1" fill className="object-cover object-center" priority={false} />
            </div>
            <div className="relative h-full w-[full] md:-ml-8">
              <Image src="https://ik.imagekit.io/libertyindia/services/education-tours/picture-2.png" alt="Education Tour 2" fill className="object-cover object-center" priority={false} />
            </div>
            <div className="relative h-full w-full">
              <Image src="https://ik.imagekit.io/libertyindia/services/education-tours/picture-3.png" alt="Education Tour 3" fill className="object-cover object-center" priority={false} />
            </div>
          </div>
          {/* Overlay Card */}
      ...
      <section className="w-full bg-white mx-auto flex mt-12 mb-4 flex-col items-center justify-center">
        <h2 className="text-center text-2xl md:text-3xl font-semibold mb-10" style={{fontFamily:'var(--font-playfair), Georgia, serif'}}>
          Social & University Group Tours
        </h2>
        <div className="relative flex justify-center items-center mx-auto" style={{height:'100vh', width:'70vw'}}>
          <Image
            src="https://ik.imagekit.io/libertyindia/services/education-tours/experiences.png"
