    ...
    <main className="min-h-screen bg-white w-full overflow-x-hidden">
      ...
      <section className="relative w-[105vw] bg-[#FDF8E8] pt-0">
        <div className="relative w-full h-[50vh] md:h-[60vh] lg:h-[70vh]">
          <Image
            src="/images/services/premium-leisure/leisure-bg.svg"
        ...
        <div className="relative w-[100vw] max-w-none mx-auto" style={{height:'750px'}}>
          <div className="grid grid-cols-1 md:grid-cols-3 w-full h-full">
            <div className="relative h-full w-full">
              <Image src="/images/services/premium-leisure/picture-1.svg" alt="Premium Leisure 1" fill className="object-cover object-center" priority={false} />
            </div>
            <div className="relative h-full w-full">
              <Image src="/images/services/premium-leisure/picture-2.svg" alt="Premium Leisure 2" fill className="object-cover object-center" priority={false} />
            </div>
            <div className="relative h-full w-full">
              <Image src="/images/services/premium-leisure/picture-3.svg" alt="Premium Leisure 3" fill className="object-cover object-center" priority={false} />
            </div>
          </div>
          {/* Overlay Card */}
      ...
      <section className="w-full flex justify-center bg-white w-[90vw] m-0 p-0 mt-16">
        <div className="relative w-[98vw] h-[90vh] md:h-[140vh] lg:h-[110vh] mx-auto">
            <Image
            src="/images/services/premium-leisure/journey-types.svg"
      ...
      <section className="flex flex-col w-[85vw] items-center mx-auto bg-white py-12 md:py-16">
        <h2 className="text-2xl md:text-3xl font-semibold text-center mb-6" style={{fontFamily:'var(--font-playfair), Georgia, serif'}}>
          ...
          <Image
            src="/images/services/premium-leisure/inclusions.svg"
