...
export const itineraries: Itinerary[] = [
  ...
  // ==========================================================================
  {
    ...
    title: "Classical Golden Triangle",
    subtitle: "Experience the iconic wonders of India's Golden Triangle. Visit the Taj Mahal at sunrise, explore Delhi's historic sites, and experience the pink city of Jaipur.",
  ...
  // ==========================================================================
  {
    ...
    startingPrice: "€950",
    startingPriceNote: "per person",
    route: "Delhi → Mandawa → Bikaner → Jaisalmer → Jodhpur → Udaipur → Bundi → Jaipur → Agra → Delhi",
    bestTime: "October – March",
    overview: [
  ...
  // ==========================================================================
  {
    ...
    startingPrice: "€1,250",
    startingPriceNote: "per person",
    route: "Lucknow → Ayodhya → Varanasi → Prayagraj → Khajuraho → Orchha → Gwalior → Agra → Delhi",
    bestTime: "October – March",
    overview: [
  ...
  // ==========================================================================
  {
    slug: "golden-triangle-with-ranthambhore",
