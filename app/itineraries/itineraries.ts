...
export const itineraries: Itinerary[] = [
  ...
  // ==========================================================================
  {
    ...
    days: [
      ...
      { day: 5, title: "Exploring Jaipur", description: "Begin with a guided excursion to the magnificent Amber Fort, the ancient capital of the Kachawaha clan. Ascend through five defensive gates to discover ornate halls, temples, and sweeping views. Nearby, visit the intriguing Panna Meena Step Well, an eight-storey 16th-century marvel with criss-crossing staircases. In the afternoon, tour the City Palace, the Jantar Mantar stone observatory, and stop for photographs at the iconic Hawa Mahal, the Palace of Winds. End the day wandering through Jaipur's colourful traditional markets.", overnight: "Jaipur", meals: ["breakfast"], image: "https://ik.imagekit.io/libertyindia/itineraries/taj-and-tigers/day-05.png" },
  ...
  // ==========================================================================
  {
    ...
    days: [
      ...
      { day: 10, title: "Depart Madurai → Chennai", description: "Transfer to Madurai Airport for your flight to Chennai. On arrival, connect with your onward international flight. End of tour.", overnight: "—", meals: ["breakfast"], image: "https://ik.imagekit.io/libertyindia/itineraries/south-india-tamil-nadu/main-bg.png" },
    ],
    inclusions: [
      "Accommodation in single/twin rooms at selected hotel category or similar",
      "Daily breakfast",
  ...
  // image URLs preserved as placeholders for the new days too.
  {
    ...
    days: [
      ...
      { day: 3,  title: "Delhi → Mandawa",                 description: "Drive to Mandawa in the Shekhawati region — Rajasthan's open-air art gallery. Check in at your heritage hotel adorned with frescoes.", overnight: "Mandawa", meals: ["breakfast"], image: "https://ik.imagekit.io/libertyindia/itineraries/colorful-rajasthan/day-3.png?updatedAt=1773539765039" },
      ...
      { day: 5,  title: "Bikaner → Jaisalmer",             description: "Drive across the Thar Desert to Jaisalmer, the Golden City. Rest of the day at leisure.", overnight: "Jaisalmer", meals: ["breakfast"], image: "https://ik.imagekit.io/libertyindia/itineraries/colorful-rajasthan/day-5.png?updatedAt=1773539176393" },
      ...
      { day: 10, title: "Udaipur → Chittorgarh → Bundi",   description: "Drive to Bundi via Chittorgarh Fort — the Rajput bastion attacked thrice in its history (1303 by Ala-ud-din Khilji, 1533 by Bahadur Shah, 1568 by Akbar) and finally returned to the Rajputs under Jahangir in 1616.", overnight: "Bundi", meals: ["breakfast"], image: "https://ik.imagekit.io/libertyindia/itineraries/colorful-rajasthan/day-11.png?updatedAt=1773539507149" },
      { day: 11, title: "Bundi → Jaipur",                  description: "Visit the 12th-century Menal temples and the Shiva temples at Bijolia. Explore Bundi's Taragarh Fort (14th c.) and the Rajput Chattar Mahal palace with its 18th-century paintings. Drive to Jaipur.", overnight: "Jaipur", meals: ["breakfast"], image: "https://ik.imagekit.io/libertyindia/itineraries/colorful-rajasthan/day-12.png" },
  ...
  },
  {
    ...
    days: [
      ...
      { day: 3, title: "Kolkata → Darjeeling", description: "Fly to Bagdogra, drive to Darjeeling. Evening gala dinner with Everest summiteer Tenzin (groups only).", overnight: "Darjeeling", meals: ["breakfast"], image: "https://ik.imagekit.io/libertyindia/itineraries/northeast-india-sojourn/day-3.png" },
      ...
      { day: 5, title: "Darjeeling → Pelling", description: "Drive to Pelling with stunning Kanchenjunga views. Visit Pemayangtse Monastery, one of the oldest in Sikkim.", overnight: "Pelling", meals: ["breakfast"], image: "https://ik.imagekit.io/libertyindia/itineraries/northeast-india-sojourn/day-5.png" },
  ...
  // ==========================================================================
  {
    ...
    days: [
      ...
      { day: 6,  title: "Surendra Nagar → Kevadia",                description: "Morning after breakfast, visit a nearby wildlife sanctuary (Optional). Later start your onward journey to Kevadia. Upon arrival check-in and freshen up. Evening is free for leisure. Overnight in Kevadia.", overnight: "Kevadia", meals: ["breakfast"], image: "https://ik.imagekit.io/libertyindia/itineraries/vibrant-gujarat-central-india/day-5.png" }, // img cross-wired: day-5.png (garden/pond) matches the wildlife-sanctuary stop
